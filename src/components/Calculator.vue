...
<style >
*{
    background: rgba(209, 6, 250, 0.918);
}
.calc{
    width: 400px;
    margin: 0 auto;
    ...
    border: 20px groove rgb(94, 73, 73);
}
.display{
    grid-column: 1/5;
    background: #333 ;
...
.btn{
    padding: 10px;
    background: linear-gradient(#fafafa,#60a171);
    border: 1px solid rgb(99, 33, 33);
    cursor: pointer;

}
.btn:active{
    background: rgba(181, 14, 231, 0.925);  
    color: #fff;  
}
.operator{
    color: #b11ef5;
